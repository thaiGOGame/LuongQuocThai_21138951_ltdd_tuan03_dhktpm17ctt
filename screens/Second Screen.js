  ...
  return (
    <ScrollView stickyHeaderIndices={[0]}>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: 'white' }}>
        <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20, alignItems: 'center', paddingHorizontal: 20, paddingVertical: 10, backgroundColor: 'white' }}>
          <TouchableOpacity onPress={() => { navigation.navigate("First Screen") }}></TouchableOpacity>
          <Image source={require('../../../assets/images/Image 183.png')} style={{ height: 25, width: 25 }} />
        </TouchableOpacity>
        <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20, alignItems: 'center', paddingHorizontal: 20, paddingVertical: 10, backgroundColor: 'white' }}>
          <TouchableOpacity onPress={() => { navigation.navigate("Third Screen") }}></TouchableOpacity>
          <Image source={require('../../../assets/images/Image 182.png')} style={{ height: 25, width: 25 }} />
        </TouchableOpacity>
      </View>
      <View>
        <TextInput style={{ borderWidth: 1, borderColor: 'gray', borderRadius: 10, width: '90%', height: 50, alignSelf: 'center', marginTop: 20, paddingLeft: 20, fontSize: 20 }} placeholder='Search' />
      </View>
      <View style={{
        width: '100%',
        flexDirection: 'row',
